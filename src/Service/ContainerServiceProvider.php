...
class ContainerServiceProvider implements ServiceProviderInterface
{
    ...
    protected function laravelApplication(): bool
    {
        ...
        Pay::set(\Pengxul\Chamipay\Contract\ContainerInterface::class, LaravelContainer::getInstance());
    ...
    protected function hyperfApplication(): bool
    {
        ...
        Pay::set(\Pengxul\Chamipay\Contract\ContainerInterface::class, HyperfContainer::getContainer());
